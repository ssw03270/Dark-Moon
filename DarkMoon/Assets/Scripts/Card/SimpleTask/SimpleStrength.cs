...
public class SimpleStrength : SimpleTask
{
    ...
    public override void Task(bool isPlayer, int entity_position, int amount)
    {
        if (isPlayer)
        {
            ...
            current_field.player_entity[entity_position].entity_strength += amount;
        }
        else
        {
            ...
            current_field.enemy_entity[entity_position].entity_strength += amount;
        }
    }
}
