...
public class Berserk : CardBase
{
    ...
    public override void Awake()
    {
        ...
        Tuple<SimpleTask, int> simple_strength = new Tuple<SimpleTask, int>(new SimpleStrength(), 3);
        Tuple<SimpleTask, int> simple_weak = new Tuple<SimpleTask, int>(new SimpleWeak(), 3);
